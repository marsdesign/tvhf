 ...
 */
class Bootstrap_Sendfriend_ProductController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function sendmailAction()
    {
        ...
        try {
            ...
            if ($validate === true) {
                $model->send();
                Mage::getSingleton('catalog/session')->addSuccess($this->__('Thank you for sharing with your friends.'));
                //$this->_redirectSuccess($product->getProductUrl());
                $this->_redirectSuccess(Mage::getURL('*/*/send', array('_current' => true)));
                return;
            }
            else {
